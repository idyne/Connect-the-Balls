...
public class SDKManager : MonoBehaviour
{
    ...
    private const string BannerAdUnitId = "b50706063413510a";
    private const string InterstitialAdUnitId = "bd8f30e121ab6fd9";
    private const string RewardedAdUnitId = "4a00f11fd5639d00";
    ...
    public void ShowInterstitial()
    {
        ...
        Debug.Log(!saveData.Value.NoAds);
        if (MaxSdk.IsInterstitialReady(InterstitialAdUnitId) && canShowInterstitial && !saveData.Value.NoAds)
        {
            Debug.Log("Showing");
    ...
    */
    ...
    {
        if (saveData.Value.NoAds) return;
